...
void p(int (&a)[STAGE]){
    if (STAGE == 7) {
	int b[7] = {a[1], a[3], a[0], a[5], a[2], a[6], a[4]};
    	for (int i=0; i < STAGE; i++) {
	    	a[i] = b[i];
		}
    }
    if (STAGE == 9) {
	int b[9] = {a[1], a[3], a[0], a[5], a[2], a[7], a[4], a[8], a[6]};
    	for (int i=0; i < STAGE; i++) {
	    	a[i] = b[i];
		}
    }
    if (STAGE == 11) {
	int b[11] = {a[1], a[3], a[0], a[5], a[2], a[7], a[4], a[9], a[6], a[10], a[8]};
...
void inv_p(int (&a)[STAGE]){
    if (STAGE == 7) {
	int b[7] = {a[2], a[0], a[4], a[1], a[6], a[3], a[5]};
    	for (int i=0; i < STAGE; i++) {
	    	a[i] = b[i];
		}
    }
    if (STAGE == 9) {
	int b[9] = {a[2], a[0], a[4], a[1], a[6], a[3], a[8], a[5], a[7]};	
    	for (int i=0; i < STAGE; i++) {
	    	a[i] = b[i];
		}
    }
    if (STAGE == 11) {
	int b[11] = {a[2], a[0], a[4], a[1], a[6], a[3], a[8], a[5], a[10], a[7], a[9]};
    	for (int i=0; i < STAGE; i++) {
	    	a[i] = b[i];
		}
    }
...
void b(int (&a)[STAGE]){
    if (STAGE == 7) {
	int b[7] = {a[1], a[3], a[0], a[4], a[2], a[5], a[6]};
    	for (int i=0; i < STAGE; i++) {
	    	a[i] = b[i];
		}
    }
    if (STAGE == 9) {
	int b[9] = {a[1], a[3], a[0], a[5], a[2], a[6], a[4], a[7], a[8]};
    	for (int i=0; i < STAGE; i++) {
	    	a[i] = b[i];
		}
    }
    if (STAGE == 11) {
	int b[11] = {a[1], a[3], a[0], a[5], a[2], a[7], a[4], a[8], a[6], a[9], a[10]};
...
void inv_b(int (&a)[STAGE]){
    if (STAGE == 7) {
	int b[7] = {a[2], a[0], a[4], a[1], a[3], a[5], a[6]};
    	for (int i=0; i < STAGE; i++) {
	    	a[i] = b[i];
		}
    }
    if (STAGE == 9) {
	int b[9] = {a[2], a[0], a[4], a[1], a[6], a[3], a[5], a[7], a[8]};	
    	for (int i=0; i < STAGE; i++) {
	    	a[i] = b[i];
		}
    }
    if (STAGE == 11) {
	int b[11] = {a[2], a[0], a[4], a[1], a[6], a[3], a[8], a[5], a[7], a[9], a[10]};
    	for (int i=0; i < STAGE; i++) {
	    	a[i] = b[i];
		}
    }
...
void s(int (&a)[STAGE]){
    if (STAGE == 7) {
	int b[7] = {a[1], a[3], a[0], a[4], a[2], a[6], a[5]};
    	for (int i=0; i < STAGE; i++) {
	    	a[i] = b[i];
		}
    }
    if (STAGE == 9) {
	int b[9] = {a[1], a[3], a[0], a[5], a[2], a[6], a[4], a[8], a[7]};
    	for (int i=0; i < STAGE; i++) {
	    	a[i] = b[i];
		}
    }
    if (STAGE == 11) {
	int b[11] = {a[1], a[3], a[0], a[5], a[2], a[7], a[4], a[8], a[6], a[10], a[9]};
...
void inv_s(int (&a)[STAGE]){
    if (STAGE == 7) {
	int b[7] = {a[2], a[0], a[4], a[1], a[3], a[6], a[5]};
    	for (int i=0; i < STAGE; i++) {
	    	a[i] = b[i];
		}
    }
    if (STAGE == 9) {
	int b[9] = {a[2], a[0], a[4], a[1], a[6], a[3], a[5], a[8], a[7]};	
    	for (int i=0; i < STAGE; i++) {
	    	a[i] = b[i];
		}
    }
    if (STAGE == 11) {
	int b[11] = {a[2], a[0], a[4], a[1], a[6], a[3], a[8], a[5], a[7], a[10], a[9]};
    	for (int i=0; i < STAGE; i++) {
	    	a[i] = b[i];
		}
    }
...
int optimise_end_row(int (&end_row)[STAGE], std::string &calling) {
...
void get_touch(int start_row[STAGE], int (&end_row)[STAGE], bool optimise) {
    ...
    if (optimise){
	index = optimise_end_row(end_row, calling);
    }
    else {
    ...
    int length = table[index].distance;
...
int main() {
	...
	int start_row[STAGE]  = {1, 2, 3, 4, 5, 6, 7, 8, 9};
    int target_row[STAGE] = {1, 9, 8, 7, 6, 5, 4, 3, 2};
	bool optimise = true;

    get_touch(start_row, target_row, optimise);
